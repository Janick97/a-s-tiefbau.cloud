...
function LayoutContent({ children, currentPageName, user, bauleiter, monteure, handleLogout }) {
  ...
  return (
                          ...
                          <Collapsible
                            ...
                            <SidebarMenuItem>
                              <CollapsibleTrigger asChild>
                                <SidebarMenuButton
                                  className={`hover:bg-orange-50 hover:text-orange-600 transition-all duration-200 rounded-xl py-3 px-4 ${
                                ...
                                <SidebarMenuSub className="ml-4 mt-2 space-y-1">
                                  <SidebarMenuSubItem>
                                    <SidebarMenuSubButton asChild>
                                      <Link
                                        to={item.url}
                                        className="text-gray-600 hover:text-orange-600 hover:bg-orange-50 rounded-lg py-2 px-3 text-sm"
                                  ...
                                  <SidebarMenuSubItem>
                                    <SidebarMenuSubButton asChild>
                                      <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-gray-600 hover:text-orange-600 hover:bg-orange-50 rounded-lg py-2 px-3 text-xs whitespace-normal break-words flex items-center"
                                        onClick={handleLinkClick}>
    ...
    <main className="flex-1 flex flex-col">
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-sm border-b border-gray-200/50 px-4 py-3 shadow-sm no-print">
